...
#ifndef __COLORFULSTREAK__
#define __COLORFULSTREAK__

#include "BaseEffecTV.h"

class ColorfulStreak : public BaseEffecTV {
...
protected:
	...
	unsigned char** planetableR;
	unsigned char** planetableG;
	unsigned char** planetableB;
